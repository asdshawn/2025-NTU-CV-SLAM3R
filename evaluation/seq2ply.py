...
if __name__ == '__main__':
    ...
    parser.add_argument("-inp", "--input", dest="sequence_path",
                        help="Path to the sequence directory containing frames with .color.png, .proj.png, and .pose.txt files",
                        required=True)
    parser.add_argument("-outp", "--output", dest="ply_path",
                        help="Path to save the output .ply file",
                        default=f"{os.curdir}/../data/gt_points/unknown.ply")
    
    sequence_path = parser.parse_args().sequence_path
    ply_path = parser.parse_args().ply_path
